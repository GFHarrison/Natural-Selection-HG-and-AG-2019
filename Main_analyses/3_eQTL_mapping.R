HUGO         ensembl                   snps  statistic    pvalue       FDR         beta   Fdr_SAB Fndr_SAB
2780 ENSG00000204790 ENSG00000204790  "chr9" 69204538 69269662             rs9413988 -0.9487103 0.3468443 0.7776344 -0.132433074 0.4301109        0
5781           NOMO1 ENSG00000103512 "chr16" 14927538 14990017
...
for(iteration in 0:iterations){
    ...
    if(iteration==0){
        ...
        event.bestQTL=read.table(paste0(permuted_pvalues_folder,"/result_permuted_",iteration,".txt"),header=TRUE)}
    if(iteration==0){
